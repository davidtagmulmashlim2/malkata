      ...
      <div className="flex flex-col h-full text-right group">
          ...
          <div className="cursor-pointer">
            <div className="relative aspect-square w-full overflow-hidden rounded-lg">
                ...
                {!dish.is_available && (
                 ...
                 <div
                    className={cn(
                        "absolute inset-x-0 bottom-0 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-2 p-1",
                    )}
        ...
        <div className="mt-2 flex-grow flex items-start justify-between gap-4">
            ...
            <div className="flex-shrink-0 flex flex-col items-center gap-1">
                ...
                <div className="text-center w-full min-h-[2.5rem] flex flex-col justify-center">
                    <span className="text-md md:text-lg font-bold leading-tight">{dish.price} ₪</span>
                    {dish.price_subtitle && <p className="text-xs text-muted-foreground leading-tight w-full whitespace-nowrap">{dish.price_subtitle}</p>}
                </div>
            </div>
        </div>
      </div>
