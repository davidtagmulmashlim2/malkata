...
export const DEFAULT_APP_STATE: AppState = {
  siteContent: {
    ...
    about: {
      ...
      long: 'סיפורה של "מלכתא" מתחיל במטבח של סבתא, שם התבשל הקסם. כל מנה שלנו היא מסע بزמן, חזרה לטעמים של פעם, לארוחות שישי ולחגים. אנו מאמינים שאוכל הוא יותר מסתם מזון - הוא זיכרון, הוא חוויה, והוא חיבור. לכן, אנו מקפידים על כל פרט, מהירקות הטריים שאנחנו בוחרים בבוקר ועד לבישול האיטי והסבלני שמוציא את המיטב מכל תבשיל. בואו לחוות איתנו את טעם הבית.',
