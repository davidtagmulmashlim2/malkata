...
export default function Home() {
  ...
  const textSizeClasses: { [key: string]: string } = {
      'xs': 'text-xs md:text-xs', 'sm': 'text-sm md:text-sm', 'base': 'text-base md:text-base', 'lg': 'text-lg md:text-lg', 'xl': 'text-xl md:text-xl', 
      '2xl': 'text-2xl md:text-2xl', '3xl': 'text-3xl md:text-3xl', '4xl': 'text-3xl md:text-4xl', '5xl': 'text-4xl md:text-5xl', 
      '6xl': 'text-5xl md:text-6xl', '7xl': 'text-6xl md:text-7xl', '8xl': 'text-7xl md:text-8xl', '9xl': 'text-8xl md:text-9xl',
  };
